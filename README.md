...
> A HTML to practive basic form element and to complete microverse entrance test.
...
Feel free to check the [issues page](https://github.com/0prodigy/surver-form/issues).
